        ...
        <div className="space-y-3">
          {notifications.length === 0 ? (
            ...
            notifications.map((notif) => (
              <Card 
                key={notif._id} 
                className={`p-4 flex items-start space-x-4 transition-all hover:shadow-md border-l-4 ${notif.read ? 'border-l-transparent bg-card/50' : 'border-l-primary bg-card shadow-sm'}`}
              >
