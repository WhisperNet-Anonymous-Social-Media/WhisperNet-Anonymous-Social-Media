...
import { Home, Bell, User, Shield, LogOut, Sun, Moon, MessageSquare } from 'lucide-react'; 
    ...
    <div className="flex flex-col h-full p-4 border-r border-border/40 bg-background">
      ...
      <nav className="flex-1 flex flex-col space-y-2">
        ...
        {isAdmin && onAdminToggle && (
           <Button variant='ghost' onClick={onAdminToggle} className="w-full justify-start text-lg">
      ...
      <div className="mt-auto space-y-2">
        <Button variant="ghost" onClick={toggleTheme} className="w-full justify-start text-lg">
            ...
            <span className="ml-10">{theme === 'light' ? 'Dark' : 'Light'} Mode</span>
        </Button>

        <Button variant="ghost" size="sm" onClick={onLogout} className="w-full justify-start text-destructive hover:text-destructive hover:bg-destructive/10 text-lg">
