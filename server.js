...
const corsOrigins = (
    ...
    "http://localhost:5173,http://127.0.0.1:5173,http://localhost:3000,https://whispernet-frontend-mdarishkhan570-dev.apps.rm2.thpm.p1.openshiftapps.com,https://whispernet-anonymous-campus.netlify.app"
)
    .split(",")
